...
async function main() {
	try {
		...
		try {
			...
			// console.log('\n--> Evaluate Transaction: getChaincodeStatus, function returns all the current assets on the ledger');
			// let result = await contract.evaluateTransaction('getChaincodeStatus');
